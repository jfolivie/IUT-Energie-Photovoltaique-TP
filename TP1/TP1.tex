...
Les cellules à colorant doivent être vues comme des photopiles que l'on peut schématiser de la manière suivante : 
...
Cette pile est constituée de deux demi-piles de troisième espèce, qui mettent en jeux trois couples rédox : $D^+(ads) / D(ads)$, $\ce{D^+ (ads)} / \ce{D^\star (ads)}$ et $\ce{I_3^- (aq)} / \ce{I^- (aq)}$.
...
\begin{center}
\begin{tabular}{cc}
\subfloat[\label{fig:TP1-02a}]{\includegraphics[width=7cm]{figures/Fig02a}} & \subfloat[\label{fig:TP1-02b}]{\includegraphics[width=7cm]{figures/Fig02b}} \\
\subfloat[\label{fig:TP1-02c}]{\includegraphics[width=7cm]{figures/Fig02c}} & \subfloat[\label{fig:TP1-02d}]{\includegraphics[width=7cm]{figures/Fig02d}} \\
\subfloat[\label{fig:TP1-02e}]{\includegraphics[width=7cm]{figures/Fig02e}} & \\
\end{tabular}
\end{center}
...
\begin{center}	\includegraphics[width=0.25\textwidth]{figures/Corr02}
\end{center}
...
\begin{align*}
\ce{I3^- (aq) + 2  neD^\star (aq) = 2 D+(aq) + 3 I-(aq)}
\end{align*}
...
\begin{itemize}
   \item Sous agitation, transférer la suspension dans des réacteurs en téflon.  
...
\item Récupération du Solide  : \`{A} la sortie du réacteur, séparer les suspensions par centrifugation à \SI{16500}{{tour}\per\minute} pendant \SI{20}{\minute}.% (29 220 g).  
...
\begin{center}
\begin{tabular}{c}
\subfloat[\label{fig:TP1-03a}]{\includegraphics[width=12cm]{figures/Fig03a}} \\ \subfloat[\label{fig:TP1-03b}]{\includegraphics[width=7cm]{figures/Fig03b}}
\end{tabular}
\end{center}
...
\subsection{Caractérisation de la phase}
...
\question[6] \`{A} partir de vos acquisitions DRX et de tout modèle qui vous semblera pertinent, caractériser, si possible, la morphologie des nanoparticules formées.
