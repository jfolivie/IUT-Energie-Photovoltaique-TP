...
\begin{figure}[H]
\begin{center}
\subfloat[\label{fig:TP2-01a}]{\includegraphics[width=0.48\textwidth]{figures/Fig01a}}\subfloat[\label{fig:TP2-01b}]{\includegraphics[width=0.48\textwidth]{figures/Fig01b}}
\end{center}
...
\subsection{Tracés des caractéristiques d'une photodiode commerciale}
